package com.koko.train.${module}.service;
...
import com.koko.train.${module}.domain.${Domain};
import com.koko.train.${module}.domain.${Domain}Example;
import com.koko.train.${module}.mapper.${Domain}Mapper;
